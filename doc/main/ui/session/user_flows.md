...
> Earlier iterations of this feature also rendered a "View virtual screen" CTA. It was removed before merge because the post-completion viewer had no working takeover / edge glow / exit affordance. The viewer CTA can return once the virtual-display runtime keeps the VD alive past completion and restores the in-viewer controls.
