...
Output to ./claude, and also generate a softlink for ./codex ./cursor, as they pretty much adopt the same format. Search online if you are not sure about some of the concepts (e.g., skills, hooks, commands etc.)