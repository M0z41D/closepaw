...
- run_id: `aw_20260224_230158_SimpleCalendarDeleteEvents_4_0`
- attempt: `0`
- bridge_status: `error`
- task_status: `failure`
...
- trace_dir: `/Users/moonkey/workspace/android-agent-workspace/androidagent/eval/results/20260224_230158/artifacts/aw_20260224_230158_SimpleCalendarDeleteEvents_4_0/trace`
...
| 5 | com.moonkey.androidagent | open_app(app_name=Calendar) | open_app:ok Success: Launched Calendar ([REDACTED_JWT].calendar) | Pass | Turn executed without obvious tool/runtime error. |
| 6 | com.google.android.gms | ask_user(type=action, message=The Calendar app requires a Google …) | (none) | Context | Requested user intervention; non-actionable in eval runner. |
